          ...
          <div class="panel-body no-padding">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                include "koneksi.php";
                $i=1;
                $sql=mysql_query("SELECT * FROM pengajuan WHERE jenis ='B2' AND status !='Belum Di Ajukan'");
                while ($d=mysql_fetch_array($sql)) {
              ...
              <div class="panel-body no-padding">
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    include "koneksi.php";
                    $i=1;
                    $sql=mysql_query("SELECT * FROM pengajuan WHERE jenis ='Rutin' AND status !='Belum Di Ajukan'");
                    while ($d=mysql_fetch_array($sql)) {
                  ...
                  <div class="panel-body no-padding">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        include "koneksi.php";
                        $i=1;
                        $sql=mysql_query("SELECT * FROM pengajuan WHERE jenis ='Non Rutin' AND status !='Belum Di Ajukan'");
                        while ($d=mysql_fetch_array($sql)) {
